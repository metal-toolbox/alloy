...
func FleetDBAPIR6515Components_fc167440_JSON() []byte {
	asBytes, err := json.Marshal(FleetDBAPIR6515Components_fc167440)
	if err != nil {
		log.Fatal(err)
	}
...
var (
	...
	FleetDBAPIR6515Components_fc167440 = fleetdbapi.ServerComponentSlice{
